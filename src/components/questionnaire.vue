...
<el-menu
  ...
  <el-menu-item index="5" disabled>规则配置</el-menu-item>
    ...
    <el-tabs v-model="activeName">
            ...
            <el-form :model="Form" label-width="130px" label-position="left">
                ...
                <el-form-item label="确定项目类型">
                    <el-radio-group v-model="sys_xmlx">
                        <el-radio label="1">单系统模式:建设的密码资源服务于单个信息系统</el-radio><br>
                        <el-radio label="2">多系统模式:共享建设的密码资源,同时支撑多个信息系统,一般一个主体建设;</el-radio><br>
                        <el-radio label="3">云租户模式:为云平台建设云密码资源池,为云租户系统动态分配密码资源;</el-radio><br>
                ...
                <el-form-item label="云上部署">
                    <el-radio-group v-model="sys_ysbs">
                ...
                <el-form-item label="若在云上">
                    <el-radio-group v-model="sys_rzys">
        ...
        <el-tab-pane label="调研简表" name="two">
            <el-row>
                <el-col :span="4">
            ...
            <el-row>
                ...
                <el-col :span="10"><div class="grid-content bg-light">
                ...
                <el-col :span="2"><div class="grid-content bg-light">
                    <br>
                    <el-radio-group v-model="mpjb_xy_sfmz">
            ...
            <el-row>
                ...
                <el-col :span="2"><div class="grid-content bg-light">
                    <br>
                    <el-radio-group v-model="mpjb_wlhhj_sfmz">
                        <el-radio label="1">是</el-radio>
                        <el-radio label="2">否</el-radio>
                    </el-radio-group>
                    </div></el-col>
            ...
            <el-row>
                ...
                <el-col :span="10"><div class="grid-content-big bg-light">
                    <el-form :model="Form" label-width="140px" label-position="left">
                        <el-form-item label="公众用户访问方式">
                            <el-checkbox-group v-model="mpjb_fwfs">
                        ...
                        <el-form-item label="硬件终端">
                            <el-radio-group v-model="mpjb_yjzd">
                ...
                <el-col :span="2"><div class="grid-content-big bg-light">
                    <br>
                    <el-radio-group v-model="mpjb_wlhtx_sfmz">
                        <el-radio label="1">是</el-radio>
                        <el-radio label="2">否</el-radio>
                    </el-radio-group>
                    </div></el-col>
            ...
            <el-row>
                ...
                <el-col :span="10"><div class="grid-content-large bg-light">
                    <el-form :model="Form" label-width="100px" label-position="left">
                        <br>
                        <el-form-item label="数据库">
                            <el-radio-group  v-model="mpjb_sjk">
                                <el-radio label="1">Oracle</el-radio>
                                <el-radio label="2">SQL Server</el-radio>
                                <el-radio label="3">MySQL</el-radio>
                                <el-radio label="4">其它：
                                    <el-input v-model="mpjb_sjk_qt" style="width: 140px" size="mini" placeholder="" ></el-input>
                                </el-radio>
                            </el-radio-group>
                        </el-form-item>
                        <el-form-item label="SSL VPN">
                            <el-radio-group  v-model="mpjb_sslvpn">
                                <el-radio label="1">无</el-radio>
                                <el-radio label="2">有，品牌型号
                                    <el-input v-model="mpjb_sslvpn_ppxh" style="width: 140px" size="mini" placeholder="" ></el-input>
                                </el-radio>
                            </el-radio-group>
                        </el-form-item>
                        <el-form-item label="IPSec VPN">
                            <el-radio-group  v-model="mpjb_ipsecvpn">
                                <el-radio label="1">无</el-radio>
                                <el-radio label="2">有，品牌型号
                                    <el-input v-model="mpjb_ipsecvpn_ppxh" style="width: 140px" size="mini" placeholder="" ></el-input>
                                </el-radio>
                            </el-radio-group>
                        </el-form-item>
                        <el-form-item label="堡垒机">
                            <el-radio-group  v-model="mpjb_blj">
                                <el-radio label="1">无</el-radio>
                                <el-radio label="2">有，品牌型号
                                    <el-input v-model="mpjb_blj_ppxh" style="width: 140px" size="mini" placeholder="" ></el-input>
                                </el-radio>
                            </el-radio-group>
                        </el-form-item>
                    </el-form>
                    </div></el-col>
                <el-col :span="2"><div class="grid-content-large bg-light">
                    <br>数据库:<br>
                    <el-radio-group v-model="mpjb_sbhjs_sjk_sfmz">
                        <el-radio label="1">是</el-radio>
                        <el-radio label="2">否</el-radio>
                    </el-radio-group>
                    <br><br><br>
                    VPN:<br>
                    <el-radio-group v-model="mpjb_sbhjs_vpn_sfmz">
                        <el-radio label="1">是</el-radio>
                        <el-radio label="2">否</el-radio>
                    </el-radio-group>
                    </div></el-col>
            ...
            <el-row>
                ...
                <el-col :span="2"><div class="grid-content-large bg-light">
                    <br>不可否认性与电子签章:<br>
                    <el-radio-group v-model="mpjb_yyhsj_bkfrxydzqz_sfmz">
                        <el-radio label="1">是</el-radio>
                        <el-radio label="2">否</el-radio>
                    </el-radio-group>
                    <br><br>
                    传输数据量与存储数据量:<br>
                    <el-radio-group v-model="mpjb_yyhsj_cssjlyccsjl_sfmz">
                        <el-radio label="1">是</el-radio>
                        <el-radio label="2">否</el-radio>
                    </el-radio-group>
                    </div></el-col>
        ...
        <el-tab-pane label="系统用户情况" name="three">
            <el-form label-width="120px">
                ...
                <el-row>
                    ...
                    <el-table-column align="center" label="业务应用">
                        <template slot-scope="scope">
                        <el-input v-model="scope.row.ywyy" placeholder="请输入业务应用名称"></el-input>
                        </template>
                    </el-table-column>
                    <el-table-column align="center" label="用户/角色">
                        <template slot-scope="scope">
                    ...
                    <el-table-column align="center" label="登录方式(多选)">
                        <template slot-scope="scope">
                    ...
                    <el-table-column align="center" label="身份认证方式(多选)">
                        <template slot-scope="scope">
                    ...
                    <el-table-column align="center" label="所在网络(多选)">
                        <template slot-scope="scope">
                            <el-checkbox-group v-model="scope.row.szwl">
                                <el-checkbox
                                v-for="item in xtyhqk_szwl_options"
                                :key="item.value"
                                :label="item.value"
                                >{{item.label}}
                                </el-checkbox>
        ...
        <el-tab-pane label="物理和环境" name="four">
            <el-form label-width="120px">
                ...
                <el-row>
                    ...
                    <el-table-column align="center" label="机房名称">
                        <template slot-scope="scope">
                        <el-input v-model="scope.row.jfmc" placeholder="请输入机房名称"></el-input>
                        </template>
                    </el-table-column>
                    <el-table-column align="center" label="机房类型" width="120px">
                        <template slot-scope="scope">
                            <el-radio-group v-model="scope.row.jflx">
                                <div><el-radio label="1">新机房</el-radio></div><br>
                                <div><el-radio label="2">旧机房</el-radio></div><br>
                                <div><el-radio label="3">租机房</el-radio></div><br>
                            </el-radio-group>
                        </template>
                    </el-table-column>
                    <el-table-column align="center" label="门禁" width="120px">
                        <template slot-scope="scope">
                            <el-radio-group v-model="scope.row.mj">
                                <div><el-radio label="1">国密电子</el-radio></div><br>
                                <div><el-radio label="2">普通电子</el-radio></div><br>
                                <div><el-radio label="3">非电子</el-radio></div><br>
                                <div><el-radio label="4">无</el-radio></div><br>
                            </el-radio-group>
                        </template>
                    </el-table-column>
                    <el-table-column align="center" label="身份认证方式(多选)" >
                    ...
                    <el-table-column align="center" label="视频监控" width="120px">
                        <template slot-scope="scope">
                            <el-radio-group v-model="scope.row.spjk">
                                <div><el-radio label="1">国密</el-radio></div><br>
                                <div><el-radio label="2">普通</el-radio></div><br>
                                <div><el-radio label="3">无</el-radio></div><br>
                            </el-radio-group>
                        </template>
                    </el-table-column>
                    <el-table-column align="center" label="是否允许增加设备" width="120px">
                        <template slot-scope="scope">
                            <el-radio-group v-model="scope.row.zjsb">
                                <div><el-radio label="1">允许</el-radio></div><br>
                                <div><el-radio label="2">不允许</el-radio></div>
                            </el-radio-group>
                        </template>
                    </el-table-column>
                    <el-table-column align="center" label="操作" width="80px">
        ...
        <el-tab-pane label="网络和通信" name="five">
            测评对象是跨网络访问的通信信道，特别指从不受保护的网络区域访问被测系统，一般从通信主体和所在网络类型来分析，网络类型分为互联网(完全公开)、办公局域网(如公务员办公接入政务外网、医生办公接入医院局域网等)、内网(如机房内网络、某些专线网络)等。
            <el-form label-width="120px">
                <el-row>
                    <el-col :span="24">
                    ...
                    <el-table-column align="center" label="是否涉及重要数据传输" width="80px">
                        <template slot-scope="scope">
                            <el-radio-group v-model="scope.row.zysj">
                                <div><el-radio label="1">是</el-radio></div><br>
        ...
        <el-tab-pane label="设备和计算（服务器）" name="six">
            ...
            <el-form label-width="310px">
                ...
                <el-row>
                    ...
                    <el-table-column align="center" label="操作系统" width="150px">
                        <template slot-scope="scope">
                             <el-radio-group v-model="scope.row.czxt">
                                <div><el-radio label="1">Linux</el-radio></div><br>
                                <div><el-radio label="2">Windows</el-radio></div><br>
                                <div><el-radio label="3">UNIX</el-radio></div><br>
                                <div><el-radio label="4">其他</el-radio></div><br>
                            </el-radio-group>
                        </template>
                    </el-table-column>
                    <el-table-column align="center" label="数据库" width="150px">
                        <template slot-scope="scope">
                            <el-radio-group v-model="scope.row.sjk">
                                <div><el-radio label="1">Oracle</el-radio></div><br>
                                <div><el-radio label="2">MySQL</el-radio></div><br>
                                <div><el-radio label="3">SQL Server</el-radio></div><br>
                                <div><el-radio label="4">NewSQL</el-radio></div><br>
                                <div><el-radio label="5">无</el-radio></div><br>
                            </el-radio-group>
                        </template>
                    </el-table-column>
                    <el-table-column align="center" label="是否支持远程运维" width="80px">
                        <template slot-scope="scope">
                    ...
                    <el-table-column align="center" label="运维人身份认证(多选)" width="120px">
                        <template slot-scope="scope">
                            <el-checkbox-group v-model="scope.row.sfrz">
                                <el-checkbox
                    ...
                    <el-table-column align="center" label="通过堡垒机管理" width="80px">
                        <template slot-scope="scope">
        ...
        <el-tab-pane label="设备和计算（专用设备）" name="seven">
            密码产品/设备包括：服务器密码机、云密码机、签名验签服务器、时间戳服务器、证书认证系统、(手机盾)协同签名系统、安全电子签章系统、密钥管理系统等;具有密码功能的网络及安全设备包括：SSL VPN、IPSec VPN、堡垒机等; 采用密码技术的其他产品包括：动态口令系统、统一身份认证系统、特权账号管理系统等，没有密码功能的网络及安全设备包括路由器、交换机、防火墙、入侵检测系统等，虚拟设备和系统包括云计算平台、超融合一体机等。
            <br>
            <el-form label-width="310px">
                <el-row>
                    <el-col :span="24">
                ...
                <el-row>
                    ...
                    <el-table-column align="center" label="是否支持国密算法" width="80px">
                        <template slot-scope="scope">
                    ...
                    <el-table-column align="center" label="是否有商密证书" width="80px">
                        <template slot-scope="scope">
                    ...
                    <el-table-column align="center" label="运维人身份认证(多选)" width="160px">
                        <template slot-scope="scope">
                            <el-checkbox-group v-model="scope.row.sfrz">
                                <el-checkbox
                                v-for="item in sbhjs_sfrz_options"
            ...
            <el-form label-width="310px">
                ...
                <el-row>
                    ...
                    <el-table-column align="center" label="业务应用" width="230px">
                        <template slot-scope="scope">
                            <el-input v-model="scope.row.ywyy" placeholder="请输入"></el-input>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column align="center" label="对外服务方式" width="100px">
                        <template slot-scope="scope">
                            <el-radio-group v-model="scope.row.fwfs">
                                <div><el-radio label="1">HTTPS</el-radio></div>
                                <br>
                                <div><el-radio label="2">HTTP</el-radio></div>
                                <br>
                                <div><el-radio label="3">其它</el-radio></div>
                            </el-radio-group>
                        </template>
                    </el-table-column>
                    <el-table-column align="center" label="操作需要不可否认性" width="160px">
                        <template slot-scope="scope">
                            <el-radio-group v-model="scope.row.bkfr">
                                <div><el-radio label="1">没有需求</el-radio></div>
                                <br>
                                <div><el-radio label="2">有需求&未做</el-radio></div>
                                <br>
                                <div><el-radio label="3">有需求&已做</el-radio></div>
                            </el-radio-group>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column align="center" label="需要电子签名&电子印章" width="160px">
                        <template slot-scope="scope">
        ...
        <el-tab-pane label="应用和数据（重要数据）" name="nine">
            <el-form label-width="110px">
                ...
                <el-row>
                    ...
                    <el-table-column align="center" label="存储加密" width="100px">
                        <template slot-scope="scope">
                            <el-radio-group v-model="scope.row.ccjm">
                                <div><el-radio label="1">国密</el-radio></div>
                                <br>
                                <div><el-radio label="2">非国密</el-radio></div>
                                <br>
                                <div><el-radio label="3">未加密</el-radio></div>
                            </el-radio-group>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column align="center" label="传输加密" width="100px">
                        <template slot-scope="scope">
                            <el-radio-group v-model="scope.row.csjm">
                                <div><el-radio label="1">不涉及</el-radio></div>
                                <br>
                                <div><el-radio label="2">国密</el-radio></div>
                                <br>
                                <div><el-radio label="3">非国密</el-radio></div>
                                <br>
                                <div><el-radio label="4">未加密</el-radio></div>
                            </el-radio-group>
                        </template>
                    </el-table-column>
        ...
        <el-tab-pane label="产品清单" name="ten">
            ...
            <el-table-column label="备注" width="180px" align="center" prop="num">
                <template slot-scope="scope"> 
                    <el-input v-model="scope.row.remark" placeholder="价格"></el-input>
                </template>
            </el-table-column>
        </el-table>
        </el-tab-pane>
    ...
    data () {
        return {
            ...
            zysjqk_sjlx_options: [{
                ...
                value: '4',
                label: '个人敏感信息(包括且不限财产、健康生理、生物识别、身份等)'
            }, {
                value: '5',
                label: '法律法规规定的其他重要数据(包括且不限公检法、医疗、金融等行业涉及法律、合同、证据等)'
            }, {
                value: '6',
                label: '访问控制信息'
            }],
